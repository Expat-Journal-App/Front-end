      ...
      <Form className="create-story-form">
        ...
        <label>
          ...
          <Field
            ...
            name="date_trip"
            placeholder="Enter the date of your trip!"
          />
        </label>
        <ErrorMessage
          name="date_trip"
        ...
        <label>
          ...
          <Field
            ...
            className="all-fields"
            name="description"
            placeholder="Enter the image description of the image!"
          />
        </label>
        <ErrorMessage
          name="description"
...
const formikCreateNewStory = withFormik({
  ...
  handleSubmit(values, tools) {
    axios
      .post("https://morning-sea-62543.herokuapp.com/api/stories", values)
      .then(response => {
